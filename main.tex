  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[x={(img3.south east)},y={(img1.north west)}]
        ...
        % 绘制箭头连线表示操作顺序
        \draw[-{Stealth[scale=0.8]}, red, thick] (new.east) to [out=0, in=180] (fold.west);
        \draw[-{Stealth[scale=0.8]}, red, thick] (fold.east) to [out=0, in=180] (name.west);
      \end{scope}
    \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[x={(img2.south east)},y={(img1.north west)}]
        ...
        \draw[-{Stealth[scale=0.8]}, red, thick] (new.east) to [out=0, in=180] (import.west);
        \draw[-{Stealth[scale=0.8]}, red, thick] (import.east) to [out=0, in=180] (icloud.west);
        \draw[-{Stealth[scale=0.8]}, red, thick] (icloud.east) to [out=0, in=180] (pdfname.west);
        \draw[-{Stealth[scale=0.8]}, blue, thick] (icloudroot.east) to [out=0, in=180] (icloudpdf.west);
        \draw[-{Stealth[scale=0.8]}, blue, thick] (icloudpdf.south) to [out=-90, in=45] (pdfname.north);
      \end{scope}
    \end{tikzpicture}
  \end{center}
\end{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \begin{scope}[x={(img2.south east)},y={(img1.north west)}]
        ...
        \draw[-{Stealth[scale=0.8]}, blue, thick] (pdffold.west) to [out=180, in=90] (new.north);
        \draw[-{Stealth[scale=0.8]}, red, thick] (new.east) to [out=0, in=180] (import.west);
        \draw[-{Stealth[scale=0.8]}, red, thick] (import.east) to [out=0, in=180] (ipad.west);
        \draw[-{Stealth[scale=0.8]}, red, thick] (ipad.east) to [out=0, in=180] (pdfname.west);
...
\begin{frame}{iOS平板}{Goodnotes}
  ...
  \item 打开PDF文件
    \begin{itemize}
    \item 进入\enquote{PDF批注}文件夹
    \item 从\enquote{邮箱}打开
    \end{itemize}
  \end{itemize}
  \begin{center}
    \begin{tikzpicture}
      \node[anchor=south west, inner sep=0](img1) at (0,0)
      {\includegraphics[width=0.45\textwidth]{05goodnotes/06openfrommail}};
      \node[anchor=south west, inner sep=0, right=0.1 of img1](img2) 
      {\includegraphics[width=0.45\textwidth]{05goodnotes/05importmyipad}};
